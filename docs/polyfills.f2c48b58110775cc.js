...
(self.webpackChunkindirara_github_io = self.webpackChunkindirara_github_io || []).push([
  ...
  {
    955: (De, de, Te) => {
      const pe = 'undefined' != typeof globalThis && globalThis,
        ...
        He =
          ...
          self,
        Ce = pe || ('undefined' != typeof global && global) || Ae || He,
        me = function ($, ...ne) {
          if (me.translate) {
    ...
    583: () => {
      !(function (e) {
        ...
        const g = {
          name: '',
          onHasTask: (L, p, t, o) => L.hasTask(t, o),
          onScheduleTask: (L, p, t, o) => L.scheduleTask(t, o),
          onInvokeTask: (L, p, t, o, y, P) => L.invokeTask(t, o, y, P),
          onCancelTask: (L, p, t, o) => L.cancelTask(t, o),
        };
        class T {
          constructor(p, t, o) {
        ...
        let V = { parent: null, zone: new _(null, null) },
          se = null,
          ae = 0;
        function F() {}
      ...
      function Ye(e, n, i) {
        ...
        const u = r.get,
          ...
          _ = n.substr(2);
        let g = Ie[_];
        g || (g = Ie[_] = S('ON_PROPERTY' + _)),
          (r.set = function (T) {
            let m = this;
            !m && e === K && (m = K),
              m &&
                (m[g] && m.removeEventListener(_, Xe),
                f && f.apply(m, ht),
                'function' == typeof T ? ((m[g] = T), m.addEventListener(_, Xe, !1)) : (m[g] = null));
          }),
          (r.get = function () {
            let T = this;
      ...
      function ue(e, n, i) {
        let r = e;
        for (; r && !r.hasOwnProperty(n); ) r = pe(r);
        !r && e[n] && (r = e);
        const c = S(n);
        let u = null;
      ...
      function _t(e, n, i) {
        ...
        r = ue(
          ...
          (u) =>
            function (f, _) {
              const g = i(f, _);
              return g.cbIdx >= 0 && 'function' == typeof _[g.cbIdx] ? ne(g.name, _[g.cbIdx], g, c) : u.apply(f, _);
            }
        );
      }
      function fe(e, n) {
      ...
      function Tt(e, n, i) {
        ...
        function B(E, d) {
          ...
          let O = E;
          for (; O && !O.hasOwnProperty(r); ) O = pe(O);
          ...
          const p = M
            ...
            l = function (s, a, h, w, C = !1, k = !1) {
              return function () {
                ...
                Se && (Se.taskData = H);
                const _e = At.scheduleEventTask(Me, x, Se, h, w);
                return (
                  (H.target = null),
                  Se && (Se.taskData = null),
                  it && (le.once = !0),
                  (!ve && 'boolean' == typeof _e.options) || (_e.options = le),
                  (_e.target = b),
                  (_e.capture = Be),
                  (_e.eventName = N),
                  U && (_e.originalDelegate = x),
                  k ? Re.unshift(_e) : Re.push(_e),
                  C ? b : void 0
                );
              };
            };
      ...
      Zone.__load_patch('util', (e, n, i) => {
        (i.patchOnProperties = $e), (i.patchMethod = ue), (i.bindArguments = je), (i.patchMacroTask = _t);
            ...
            if (xe) {
              const f = window,
                _ = (function () {
                  ...
                  : [];
              W(f, we.concat(['messageerror']), r && r.concat(_), pe(f)),
                ...
                () =>
                  function (v, A) {
                    if (!0 === n.current[X] || v[r]) return H.apply(v, A);
                    {
                      ...
                      v && !0 === v[_] && !R.aborted && ee.state === E && ee.invoke();
                    }
                  }
              ),
              Y = ue(
